...
tbl_04_2020_divvy <- read.csv(sprintf(fileURL_Path, fileID_04_2020), fileEncoding = 'UTF-8-BOM', na.strings = c("", NA))
tbl_05_2020_divvy <- read.csv(sprintf(fileURL_Path, fileID_05_2020), fileEncoding = 'UTF-8-BOM', na.strings = c("", NA))
tbl_06_2020_divvy <- read.csv(sprintf(fileURL_Path, fileID_06_2020), fileEncoding = 'UTF-8-BOM', na.strings = c("", NA))
tbl_07_2020_divvy <- read.csv(sprintf(fileURL_Path, fileID_07_2020), fileEncoding = 'UTF-8-BOM', na.strings = c("", NA))
...
#   to match the rest.
tbl_part_I_08_2020_divvy <- read.csv(sprintf(fileURL_Path, fileID_part_I_08_2020), fileEncoding = 'UTF-8-BOM', na.strings = c("", NA))
tbl_part_II_08_2020_divvy <- read.csv(sprintf(fileURL_Path, fileID_part_II_08_2020), fileEncoding = 'UTF-8-BOM', na.strings = c("", NA))
...
tbl_09_2020_divvy <- read.csv(sprintf(fileURL_Path, fileID_09_2020), fileEncoding = 'UTF-8-BOM', na.strings = c("", NA))
tbl_10_2020_divvy <- read.csv(sprintf(fileURL_Path, fileID_10_2020), fileEncoding = 'UTF-8-BOM', na.strings = c("", NA))
tbl_11_2020_divvy <- read.csv(sprintf(fileURL_Path, fileID_11_2020), fileEncoding = 'UTF-8-BOM', na.strings = c("", NA))
tbl_12_2020_divvy <- read.csv(sprintf(fileURL_Path, fileID_12_2020), fileEncoding = 'UTF-8-BOM', na.strings = c("", NA))
