...
listGGPLOT_BAR_WEEKDAY_AVGMIN <- list(plotBAR_AVGMIN_WEEKDAY_BY_BIKE, plotBAR_AVGMIN_WEEKDAY_BY_USER, plotBAR_AVGMIN_WEEKDAY_BY_USER_BIKE)
listGGPLOT_BAR_WEEKDAY_TOTMIN <- list(plotBAR_TOTMIN_WEEKDAY_BY_BIKE, plotBAR_TOTMIN_WEEKDAY_BY_USER, plotBAR_TOTMIN_WEEKDAY_BY_USER_BIKE)
listGGPLOT_BAR_WEEKDAY_TOTRIDES <- list(plotBAR_TOTRIDES_WEEKDAY_BY_BIKE, plotBAR_TOTRIDES_WEEKDAY_BY_USER, plotBAR_TOTRIDES_WEEKDAY_BY_USER_BIKE)
...
rm(
  ...
  plotBAR_AVGMIN_WEEKDAY_BY_BIKE, plotBAR_AVGMIN_WEEKDAY_BY_USER, plotBAR_AVGMIN_WEEKDAY_BY_USER_BIKE,
  plotBAR_TOTMIN_WEEKDAY_BY_BIKE, plotBAR_TOTMIN_WEEKDAY_BY_USER, plotBAR_TOTMIN_WEEKDAY_BY_USER_BIKE,
  plotBAR_TOTRIDES_WEEKDAY_BY_BIKE, plotBAR_TOTRIDES_WEEKDAY_BY_USER, plotBAR_TOTRIDES_WEEKDAY_BY_USER_BIKE
)